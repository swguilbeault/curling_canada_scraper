...
competions = [{"url": "https://widgets.curling.io/index.html?lang=en&apiKey=qw4LUsJ1_aQ#!/competitions/4391", "name": "2019"},
              {"url": "https://widgets.curling.io/index.html?lang=en&apiKey=qw4LUsJ1_aQ#!/competitions/3385", "name": "2018"},
              {"url": "https://widgets.curling.io/index.html?lang=en&apiKey=qw4LUsJ1_aQ#!/competitions/2206", "name": "2017"},
              {"url": "https://widgets.curling.io/index.html?lang=en&apiKey=qw4LUsJ1_aQ#!/competitions/1899", "name": "2016"}]
...
for competition in competions:
    ...
    #statistics    
    driver.get(competition["url"] + "/reports/statistics_by_team")
    driver.execute_script("window.print=function(){};") #disable print dialogue    
    ...
    for team in teamOptions:
        ...
        driver.get(competition["url"] + "/reports/statistics_by_team/" + team["val"])
        driver.execute_script("window.print=function(){};") #disable print dialogue
        ...
        drawOptions = [{"name": i.getText().split(" ")[1], "val": i["value"]} for i in drawDropdown.findAll("option")]
        
        for index,draw in enumerate(drawOptions):
                print("\t\tStarting draw: " + draw["name"])

                driver.get(competition["url"] + "/reports/statistics_by_team/" + team["val"] + "/draws/" + draw["val"])
                driver.execute_script("window.print=function(){};") #disable print dialogue
...
print("\n\n\n")
print(grid2)
grid.toCSV("womens-pct-by-draw-players.csv")
grid2.toCSV("womens-pct-by-draw-teams.csv")