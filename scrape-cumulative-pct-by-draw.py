...
for competition in competions:
    ...
    for team in teamOptions:
        ...
        drawOptions = [{"name": i.getText().split(" ")[2], "val": i["value"]} for i in drawDropdown.findAll("option")]
...
print("\n\n\n")
print(grid2)
grid.toCSV("cumulative-pct-by-draw-players.csv")
grid2.toCSV("cumulative-pct-by-draw-teams.csv")